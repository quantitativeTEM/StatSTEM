function updateCheckVal(jObject,event,func,h,button)
% updateCheckVal - Run function or update StatSTEM file
%
% syntax: updateCheckVal(jObject,event,func,h,button)
