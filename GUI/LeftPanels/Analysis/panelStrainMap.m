...
panel.row(5).option1 = pushbutton('name','Make strain map xy','width',162,...
    'func','STEMstrain','input','strainmapping.indices','output','strainmapping',...
    'figEnd','Observation','figOptEnd',{[char(949),'_xx']});

panel.row(6).option1 = pushbutton('name','Make strain map ab','width',162,...
    'func','STEMstrain_ab','input','strainmapping.indices','output','strainmapping',...
    'figEnd','Observation','figOptEnd',{[char(949),'_aa']});
