function changeALat(hObject,event,h,button2)
% changeALat - Callback to change the method for finding the a-direction
%
%   syntax: changeALat(hObject,event,h)
...
if any(strcmp(fieldnames(usr.file.strainmapping),'teta'))
    quest = questdlg('Changing the method of finding a new a lattice direction will remove all previous strain mapping results, continue?','Warning','Yes','No','No');
