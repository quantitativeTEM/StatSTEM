function changeRefCoor(hObject,event,h,button2)
% changeRefCoor - Callback to change the method for finding a reference coordinate
%
%   syntax: changeRefCoor(hObject,event,h)
...
if any(strcmp(fieldnames(usr.file),'strainmapping'))
    quest = questdlg('Changing the method of finding a new reference coordinate will remove all previous strain mapping results, continue?','Warning','Yes','No','No');
