...
jPanRunFit.setBackground(Color(0.8,0.8,0.8))
set(jPanRunFit,'Border',border.LineBorder(Color(0.95,0.95,0.95),1,false))
...
jFitBut.setBackground(Color(0.8,0.8,0.8))
...
set(jFitButPan,'Border',border.LineBorder(Color(0.8,0.8,0.8),1,false))
jFitButPan.setBackground(Color(0.8,0.8,0.8))
...
jAbortBut.setBackground(Color(0.8,0.8,0.8))
...
set(jAbortButPan,'Border',border.LineBorder(Color(0.8,0.8,0.8),1,false))
jAbortButPan.setBackground(Color(0.8,0.8,0.8))
...
jAdvBut.setBackground(Color(0.8,0.8,0.8))
...
set(jAdvButPan,'Border',border.LineBorder(Color(0.8,0.8,0.8),1,false))
jAdvButPan.setBackground(Color(0.8,0.8,0.8))
...
jPanAdvFit.setSize(Dimension(168,290));jPanAdvFit.setPreferredSize(Dimension(168,290));jPanAdvFit.setMaximumSize(Dimension(168,290))
jPanAdvFit.setAlignmentX(Component.LEFT_ALIGNMENT);
jPanAdvFit.setBackground(Color(0.95,0.95,0.95))
set(jPanAdvFit,'Border',border.LineBorder(Color(0.95,0.95,0.95),1,false))
...
jPanBackground.setBackground(Color(0.8,0.8,0.8))
set(jPanBackground,'Border',border.LineBorder(Color(0.95,0.95,0.95),1,false))
...
jEditBack.setBackground(Color(0.7,0.7,0.7))
% Reference
...
jAutBackBut.setBackground(Color(0.8,0.8,0.8))
...
set(jAutBackPan,'Border',border.LineBorder(Color(0.8,0.8,0.8),1,false))
jAutBackPan.setBackground(Color(0.8,0.8,0.8))
...
jBackPan.setBackground(Color(0.8,0.8,0.8))
jBackText = JTextField;
set(jBackText,'Text','Value:');
jBackText.setEditable(false)
jBackText.setBackground(Color(0.8,0.8,0.8))
set(jBackText,'Border',border.LineBorder(Color(0.8,0.8,0.8),1,false))
...
jBackSelBut.setBackground(Color(0.8,0.8,0.8))
...
jPanWidth.setSize(Dimension(168,90));jPanWidth.setPreferredSize(Dimension(168,90));jPanWidth.setMaximumSize(Dimension(168,90))
jPanWidth.setAlignmentX(Component.LEFT_ALIGNMENT);
jPanWidth.setBackground(Color(0.8,0.8,0.8))
set(jPanWidth,'Border',border.LineBorder(Color(0.95,0.95,0.95),1,false))
...
jEditWidth.setText('+ Width of atomic columns')
...
jEditWidth.setBackground(Color(0.7,0.7,0.7))
...
jSameWidth.setBackground(Color(0.8,0.8,0.8))
...
jDifWidth.setBackground(Color(0.8,0.8,0.8))
h.left.fit.panels.Width.DiffBut = jDifWidth;
jUserWidthPan = JPanel(GridBagLayout);
jUserWidthPan.setBackground(Color(0.8,0.8,0.8))
...
jUserWidth.setBackground(Color(0.8,0.8,0.8))
...
jUserWidthBut.setBackground(Color(0.8,0.8,0.8))
...
jPanTest.setSize(Dimension(168,70));jPanTest.setPreferredSize(Dimension(168,70));jPanTest.setMaximumSize(Dimension(168,70))
jPanTest.setAlignmentX(Component.LEFT_ALIGNMENT);
jPanTest.setBackground(Color(0.8,0.8,0.8))
...
jEditTest.setBackground(Color(0.7,0.7,0.7))
...
jCoorBut.setBackground(Color(0.8,0.8,0.8))
...
jPanPara.setBackground(Color(0.8,0.8,0.8))
set(jPanPara,'Border',border.LineBorder(Color(0.95,0.95,0.95),1,false))
...
% jEditTest.setFocusable(false)
jEditPara.setBackground(Color(0.7,0.7,0.7))
...
jParaPan.setBackground(Color(0.8,0.8,0.8))
...
jParaText.setBackground(Color(0.8,0.8,0.8))
set(jParaText,'Border',border.LineBorder(Color(0.8,0.8,0.8),1,false))
