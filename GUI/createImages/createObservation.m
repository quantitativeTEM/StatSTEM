function tab = createObservation(tab,h)
...
usr.figOptions.selOpt.(['optionsImage',num2str(num)]) = uitable('Parent',usr.figOptions.selOpt.main,'units','normalized',...
    ...
    'ColumnWidth',{15 110},'CellSelectionCallback',{@optionSelected,tab,h});
...
plotCoordinates(usr.images.ax,usr.file.input.coordinates,nameTag,userdata.pathColor,'.',scaleMarker);
