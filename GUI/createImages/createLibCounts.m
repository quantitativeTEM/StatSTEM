function createLibCounts(tab, h, show)
% createLibCounts - Show counting results in observation image
%
...
options1 = [options1;{show==1 'Lib Counts'}];
options2 = [options2;{show==1 'Lib Counts'}];
...
if show
    ...
    showImage(tab,'Observation',h,1,0)
end
