function deleteAtomCounts(tab,obs)
...
% end
% 
% % Delete plotted counts
% deleteImageObject(ax,name)
% 
% % Set colormap back to gray
% colormap(ax,'gray')
% 
...
%         caxis(ax,[min(min(obs)) max(max(obs))])
%         set(obsData(i),'CData',obs);
%         break
%     end
% end
