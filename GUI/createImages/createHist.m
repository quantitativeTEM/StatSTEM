function createHist(tab,h,show)
% createHist - Create a histogram of the scattered intensities
%
%   In this function all necessary steps are taken to show the histogram
%   within the StatSTEM interface. A panel will be created to show options 
%   that can be displayed or done with the image
%
%       syntax: createHist(tab,h,show)
...
num = length(str)+1;
set(usr.figOptions.selImg.listbox,'String',[str;{'Histogram SCS'}])
if show
...
if show
    ...
    % Show histogram with fitted coordinates
