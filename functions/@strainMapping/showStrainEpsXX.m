function showStrainEpsXX(obj)
% showStrainEpsXX - make a strain map of eps xx in image
%
%   syntax - showStrainEpsXX(obj)
...
nameTag = [char(949),'_xx'];
scaleMarker = obj.mscale;
ind = ~isnan(obj.eps_xx(:,1));
data = obj.eps_xx(ind,1);
% [~,L,U,~] = isoutlier(data);
