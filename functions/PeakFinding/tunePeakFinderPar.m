...
% Close figure button
hpf.close = uicontrol('Parent',hpf.fig,'Style','pushbutton','String','Cancel','units','normalized','Position',[0.71 0.015 0.135 0.05],'FontSize',10);
hpf.storeClose = uicontrol('Parent',hpf.fig,'Style','pushbutton','String','Use values','units','normalized','Position',[0.855 0.015 0.135 0.05],'FontSize',10);
